...
namespace sga.utils
{
    public class EmailService : IEmailSender
    {
                ...
                string recipientEmail, string body)
        {
            ...
            client.Host = Generator.Base64Decode(_EmailSettings.Domain);
            client.EnableSsl = _EmailSettings.Ssl;
            client.Port = _EmailSettings.Port;
            client.Credentials = new System.Net.NetworkCredential(Generator.Base64Decode(_EmailSettings.UserName),
                                                                    Generator.Base64Decode(_EmailSettings.Password));
            MailMessage mail = new MailMessage();
            mail.Sender = new System.Net.Mail.MailAddress(Generator.Base64Decode(_EmailSettings.SenderEmail), Generator.Base64Decode(_EmailSettings.SenderName));
            mail.From = new MailAddress(Generator.Base64Decode(_EmailSettings.SenderEmail), Generator.Base64Decode(_EmailSettings.SenderName));
