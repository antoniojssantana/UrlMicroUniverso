...
namespace url.api.Services
{
    public class AuthService : BaseService, IAuthService
    {
        ...
        public Task<bool> ChangePassword(RegisterUserViewModel registerUser)
        {
            throw new NotImplementedException();
        }

        public Task<LoginResponseViewModel> Login(LoginUserViewModel loginUser)
        {
            throw new NotImplementedException();
        }

        public Task<bool> RecoverPassword(RegisterUserViewModel registerUser)
        {
            throw new NotImplementedException();
        }
        ...
        public async Task<LoginResponseViewModel> RegisterUser(RegisterUserViewModel registerUser)
        {
            ...
            if (result.Succeeded)
            {
                ...
                return await JwtGenerator(registerUser.Email);
            }
